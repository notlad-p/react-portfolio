  ...
  return (
    <div className="section" id="contact">
      <div className="contact-heading">
        <div>
          <Heading text="Contact" color="#007ACC" width="120px" />
        </div>
        <div className="email-container">
          <a className="email-link" href="mailto:contact@daltonp.dev">
            <h3
              className="grey-text"
              style={{
                margin: "15px 0 4px 0",
      ...
      <form className="contact-form" onSubmit={sendEmail}>
        ...
        <Button text="Submit" type="submit" margin="0" />
      </form>
      {transition.map(({ item, key, props }) => {
        const notification = result ? (
          <animated.div className="submit-notification" key={key} style={props}>
            <CheckCircle size={24} color="#29c7ac" />
